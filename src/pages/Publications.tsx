...
export default function Publications({ data }: PublicationsProps) {
  ...
  const publicationTypes = useMemo(() => {
    const types = new Set(data.publications.map((p) => p.type));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 reveal active">
          ...
          <p className="text-sm md:text-base text-muted-gray mt-4 leading-relaxed">
            Discover peer-reviewed articles, journal publications, and conference proceedings detailing our findings on dialect-robust automatic speech recognition, GNN knowledge graphs, and leaf-lesion computer vision systems.
          </p>
        </div>
